...
public class PropertyModel {
    int ref_list_num, user_id;
    String prop_type, bedroom, date_time, furniture, remark, reporter_name;
    float rent_price;
    Bitmap image;


    public PropertyModel(int ref_list_num, int user_id, String prop_type, String bedroom, String date_time, float rent_price, String furniture, String remark, String reporter_name, Bitmap image) {
